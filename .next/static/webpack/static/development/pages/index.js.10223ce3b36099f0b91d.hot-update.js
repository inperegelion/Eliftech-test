...
function (_React$Component) {
  ...
  function Orders() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(_this), "changePage", function (step) {
      console.log(_this.state.currentPage, step);
      if (_this.state.currentPage + step >= 0 && _this.state.currentPage + step <= _this.state.totalSize / _this.state.linesOnPage) _this.setState(function (state) {
        return _objectSpread({}, state, {
          currentPage: 2 + 1 // currentPage: (state.currentPage + step),

        });
      });
      console.log(_this.state.currentPage + step >= 0 && _this.state.currentPage + step <= _this.state.totalSize / _this.state.linesOnPage, "NOW PAGE SET TO:", _this.state.currentPage);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_7__["default"])(Orders, [{
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, this.state.currentPage), __jsx("button", {
        onClick: function onClick() {
          return _this2.changePage(1);
        },
        __source: {
...
//# sourceMappingURL=index.js.10223ce3b36099f0b91d.hot-update.js.map