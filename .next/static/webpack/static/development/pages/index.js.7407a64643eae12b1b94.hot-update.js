...
function (_React$Component) {
  ...
  function Orders() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(_this), "fetchOrders", function (from, to) {
      var ordersQuery = "?from=".concat(from ? from : _this.state.currentPage * _this.state.linesOnPage, "&to=").concat(to ? to : (_this.state.currentPage + 1) * _this.state.linesOnPage //
      );
...
//# sourceMappingURL=index.js.7407a64643eae12b1b94.hot-update.js.map